...
тестируемым и гибким. Например, вместо _saveLoadManager = new SaveLoadManager() 
внутри класса, вы просто объявляете [Inject] private SaveLoadManager _saveLoadManager, 
а DI-контейнер сам передаст готовый экземпляр. 
